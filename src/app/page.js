...
export default function Home() {
  ...
  return (
    <main className="flex flex-col h-screen justify-center items-center px-5 py-10">
      <div className="flex flex-col h-screen items-center justify-center md:w-[75%] lg:w-[50%]">
        {/* Title */}
        ...
        {/* Options */}
        <section className="flex flex-col w-full h-full py-10 px-2 gap-4 md:h-auto">
          {/* Persyaratan */}
          <div
            className="flex w-full h-full justify-between items-center  bg-white rounded-2xl px-5 cursor-pointer md:h-32 lg:h-24"
            onClick={() => openModal(1)}
          >
          ...
          {/* Perjanjian */}
          <div
            className="flex w-full h-full justify-between items-center bg-white rounded-2xl px-5 md:h-32 lg:h-24"
            onClick={() => openModal(2)}
          >
            <div className="flex items-center gap-2">
              <svg
